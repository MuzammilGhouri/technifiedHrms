    ...
    <div class="main-container container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                ...
                <a href="{{ route('dashboard') }}"><img src="{{ asset('new/img/logonew.png') }}" class="header-brand-img desktop-logo-dark" alt="logo"></a>
            </div>
                                ...
                                <div class="main-notification-list">
                                    ...
                                    <div class="media new">
                                        <div class="main-img-user online">
                                            @if($userNotifi->photo != '')
                                            <img alt="avatar" src="{{asset($userNotifi->photo)}}">
                                            @else
                                            <img alt="avatar" src="{{ asset('new/img/images.png') }}">
                                            @endif
                                        </div>
                                        <div class="media-body">
                                            @if($notify->type == 'App\notification\UserNotice')
                                            <a href="{{url('notice-detail',$notify->id)}}">
                                            @else
                                            <a href="{{url('notification',$notify->id)}}">
                                            @endif
                                                <p><strong>{{$userNotifi->name}}</strong> 
                                                @if($notify->type == 'App\notification\UserNotification')
                                                {{$notify->data['description']}}
                                                @elseif($notify->type == 'App\notification\notificationStatus')
                                                    @if($notify->data['status'] == 1)
                                                        Approved Your Leave 
                                                    @elseif($notify->data['status'] == 2)
                        ...
                        <div class="dropdown d-flex main-profile-menu">
                            <a class="d-flex" href="javascript:void(0);">
                                <span class="main-img-user">
                                    ...
                                    <img alt="avatar" src="{{asset(\Auth::user()->employee->photo)}}">
                                    @else
                                    <img alt="avatar" src="{{ asset('new/img/images.png') }}">
                                    @endif
                                </span>
                            ...
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    ...
                                    <p class="main-notification-text"> {{ Auth::user()->role->role->name }}</p>
                                </div>
