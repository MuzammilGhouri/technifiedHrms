...
<head>
    ...
    <link id="style" href="{{ asset('new/css/bootstrap.min.css') }}" rel="stylesheet" />

    <link href="{{ asset('new/css/icons.css') }}" rel="stylesheet"/>
    <link href="{{ asset('new/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('new/css/plugin.css') }}" rel="stylesheet"/>
    <link rel="stylesheet" href="{{ asset('new/css/app.css') }}" />
    <link rel="stylesheet" href="{{ asset('new/css/app1.css') }}" />
...
<body class="main-body leftmenu ltr light-theme dark-menu">
    ...
    <div id="global-loader" >
        <img src="{{ asset('new/img/loader.svg') }}" class="loader-img" alt="loader">
    </div>
        <!-- SWITCHER -->
        @include('hrms.layouts.slider')
        <!-- SWITCHER End -->
    <div class="page">
        ...
        <div class="birthdayCard">
            <img src="{{ asset('new/img/giphy.gif') }}" class="loader-img" alt="loader">
        </div>
        <!-- MAIN-CONTENT -->
...
<script src="{{ asset('new/js/sweetalert.min.js') }}"></script>
...
<!--<script src="{{ asset('new/js/card.js') }}"></script>-->
<script src="{{ asset('new/js/select2.min.js') }}"></script>
<script src="{{ asset('new/js/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('new/js/pscroll1.js') }}"></script>
<script src="{{ asset('new/js/sidemenu.js') }}"></script>
<script src="{{ asset('new/js/sidebar.js') }}"></script>
<!--<script src="{{ asset('new/js/jquery.dataTables.min.js') }}"></script>-->
...
<script src="{{ asset('new/js/circle-progress.min.js') }}"></script>
<script src="{{ asset('new/js/sticky.js') }}"></script>
...
<script src="{{ asset('new/js/jquery.repeater.min.js') }}"></script>
<script>
...
$(document).ready(function () {
        ...
        function deleteEducation(product_att_id, a){
            ...
            $.ajax({
                url: "{{ route('delete.education.variant')}}",
                type:"POST",
                data:{
                    "_token": "{{ csrf_token() }}",
                    id:id
        ...
        function deleteExperience(product_att_id, a){
            ...
            var id = product_att_id;
            $.ajax({
                url: "{{ route('delete.experience.variant')}}",
                type:"POST",
                data:{
                    "_token": "{{ csrf_token() }}",
                    id:id
...
<script>
    ...
    @elseif(session::get('flash_status') == 'danger')
        swal("Congratulations!", "{{session::get('flash_message')}}", "error")
    @endif
    @endif
</script>
