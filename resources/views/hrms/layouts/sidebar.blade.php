        ...
        <div class="main-sidebar-header main-container-1 active">
            <div class="sidemenu-logo">
                <a class="main-logo" href="{{route('dashboard')}}">
                    ...
                    <img src="{{ asset('new/img/logonew.png') }}" class="header-brand-img desktop-logo-dark" alt="logo">
            ...
            <div class="main-sidebar-body main-body-1">
                ...
                <ul class="menu-nav nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bank-account-details') }}">
                            <svg class="sidemenu-icon menu-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#979baf" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 10px;"><polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line></svg>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            ...
                            @endif
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('notice-listing') }}">Notice Listings</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('emp-detail')}}">Personal Details</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('educ-detail')}}">Education History</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('exp-detail')}}">Work Experience</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('bank-detail')}}">Bank Details</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('hr-policy') }}">
                            <svg class="sidemenu-icon menu-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
