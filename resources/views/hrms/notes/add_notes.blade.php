                    ...
                    <table class="table table-bordered text-nowrap border-bottom mb-0 border dataTable no-footer" id="recentorders" role="grid" aria-describedby="recentorders_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row">{{$i+=1}}</td>
                                <td>{{$note->name}}</td>
                                <!--<td><img src="{{asset($note->image)}}" width="150px" height="150px"/></td>-->
                                <td>
                                    <div class="btn-group text-right">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                                ...
                                                <a href="/edit-notice/{{$note->id}}" class="dropdown-item">Edit</a>
                                            
                                            
                                                <a href="/delete-notice/{{$note->id}}" class="dropdown-item">Delete</a>
...
<!--<script src="{{ asset('new/js/ckeditor.js') }}"></script>-->
