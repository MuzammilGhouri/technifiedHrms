        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Notice Detail {{$notice->id}}</li>
                </ol>
            </div>
        </div>
    <!-- -------------- Content -------------- -->
            										...
            										<div class="card-header p-4">
            											<div class="media">
            												...
            												<div class="media-body">
            													<h6 class="mb-0 mg-t-2 ms-2 tx-semibold">{{$user->name}}</h6><span class="text-muted ms-2">{{$notice->created_at->diffForHumans()}}</span> </div>
