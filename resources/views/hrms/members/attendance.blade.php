                                ...
                                <div class="panel">
                                    <div class="panel-menu allcp-form theme-primary mtn"> 
                                        <div class="row row-sm">
                                            <form class="att-search col-md-10" method="Post" action="https://hrms.technifiedlabs.com/member-attendance/{{$user->id}}"> 
                                                {{ csrf_field() }}
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                @endif
                <div>
                    <h6 class="main-content-label mb-3">{{$user->employee->name}}'s Attendance Lists</h6>
                </div>
                    ...
                    <table class="table table-bordered text-nowrap border-bottom mb-0 border dataTable no-footer" id="recentorders" role="grid" aria-describedby="recentorders_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @elseif($attendance->leave_status == "True" )
                                <td>{{convertAttendanceFrom($attendance->status)}}</td>
                                @else
                                <td>OFF</td>
                                @endif
