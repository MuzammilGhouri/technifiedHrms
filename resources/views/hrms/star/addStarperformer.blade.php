				    ...
				    <div class="card-body">
    					<div class="row row-sm">
    					    ...
    					    <div class="col-md-12 col-lg-12 col-xl-12">
    							<div class="">
    								<form action="{{ route('add-star-performer.star') }}" method="POST">
    								{{ csrf_field() }}
                    ...
                    <table class="table table-bordered text-nowrap border-bottom mb-0 border dataTable no-footer" id="recentorders" role="grid" aria-describedby="recentorders_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input data-id="{{$value->user_id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $value->status ? 'checked' : '' }} {{ (Auth::user()->isCEO()) ? 'disabled' : '' }}          >
                                </td>
                                <td>{{ Carbon\Carbon::parse($value->month)->format('F Y') }}</td>
                                ...
                                <!--                <a href="/edit-depart/{{$value->id}}" class="dropdown-item">Edit</a>-->
                                            
                                            
                                <!--                <a href="/delete-depart/{{$value->id}}" class="dropdown-item">Delete</a>-->
