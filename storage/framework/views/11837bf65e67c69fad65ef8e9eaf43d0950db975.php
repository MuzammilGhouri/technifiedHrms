            ...
            <div class="row">
                <div class="col-md-12 d-flex">    
                    ...
                    <div class="col-md-12 firstContent">
                        ...
                        ?>
                        <p>Salary Slip for the month of  <span class="dateColor" ><?php echo e($formattedDate); ?></span></p>  
                ...
                <div class="col-md-6 mt-5">
                    <table id="customers">
                          ...
                          <tr>
                            <td class="mobile-flex" data-header="Employee Code"><?php echo e($invoice->employee_code); ?></td>
                            <td class="mobile-flex" data-header="Employee Name" id="empName"><?php echo e($invoice->employee_name); ?></td>
                            <td class="mobile-flex" data-header="Date Of Joining"><?php echo e($invoice->employee_dof); ?></td>
                          </tr>
                    </table>
                </div>
                <div class="col-md-6 mt-5">
                    <table id="customers">
                          ...
                          <tr>
                            <td class="mobile-flex" data-header="Employee Designation"><?php echo e($invoice->employee_desig); ?></td>
                            <td class="mobile-flex" data-header="Employee Department"><?php echo e($invoice->department->name); ?></td>
                          </tr>
                    </table>
                </div>
                <div class="col-md-6 mt-5">
                    <table id="customers">
                          ...
                          <tr>
                            ...
                            <td class="mobile-flex" data-header="Gross Salary"><?php echo e($invoice->gross_salary); ?></td>
                            <td class="mobile-flex" data-header="Fuel Allowance"><?php echo e($invoice->fuel_allowance); ?></td>
                            <td class="mobile-flex" data-header="Cell Phone Allowance"><?php echo e($invoice->ceel_phone_allowance); ?></td>
                            <td class="mobile-flex" data-header="Special Utility"><?php echo e($invoice->special_utility); ?></td>
                            <td class="mobile-flex" data-header="Car Allowance"><?php echo e($invoice->car_allowance); ?></td>
                            <td class="mobile-flex" data-header="Maintenance Allowance"><?php echo e($invoice->maintan_allowance); ?></td>  
                            <td class="mobile-flex main" data-header="Gross Salary & Allowances"><?php echo e($invoice->gross_salary_allowance); ?></td> 
                ...
                <div class="col-md-6 mt-5">
                    <table id="customers">
                          ...
                          <tr>
                            ...
                            <td class="mobile-flex" data-header="Absent Deduction"><?php echo e($invoice->absent_deduction); ?></td>
                            <td class="mobile-flex" data-header="Tax Deduction"><?php echo e($invoice->tax_deduction); ?></td>
                            <td class="mobile-flex" data-header="EOBI"><?php echo e($invoice->eobi); ?></td>
                            <td class="mobile-flex" data-header="Loan Deduction"><?php echo e($invoice->loan_deduction); ?></td>
                            <td class="mobile-flex" data-header="Advance Salary"><?php echo e($invoice->advance_salary); ?></td>  
                            <td class="mobile-flex main" data-header="Total Deduction"><?php echo e($invoice->total_deduction); ?></td> 
                    ...
                    <table id="customers" class="mt-5">
                          ...
                          <tr>
                            <td class="mobile-flex main" data-header="Net Salary Disbursement"><?php echo e($invoice->net_salary_disbursement); ?></td>
                          </tr>
                    </table>
                </div>
