            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap border-bottom mb-0 border dataTable no-footer example1"  id="recentorders"  role="grid" aria-describedby="recentorders_info">
                        ...
                        <tbody>
                            <?php $i =0;?>
                            <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td scope="row"><?php echo e($i+=1); ?></td>
                                <td><?php echo e($emp->code); ?></td>
                                <td><?php echo e($emp->user->name); ?></td>
                                <td><?php echo e($emp->user->email); ?></td>
