...
// $notification = DB::table('notifications')->where('notifiable_id',auth()->user()->id)->get();
// $notifi = DB::table('notifications')->where('notifiable_id',auth()->user()->id)->take(3)->get();
?>
<div class="main-header side-header sticky">
    <div class="main-container container-fluid">
        <div class="main-header-left">
            ...
            <div class="hor-logo">
                <a class="main-logo" href="<?php echo e(route('dashboard')); ?>">
                    ...
                    <img src="https://laravel8.spruko.com/dashplex/build/assets/img/brand/logo-light.png" class="header-brand-img desktop-logo-dark" alt="logo"> -->
                </a>
            </div>
        </div>
        <div class="main-header-center">
            <div class="responsive-logo">
                <!--<a href="<?php echo e(route('dashboard')); ?>">HRMS</a>-->
                <a href="<?php echo e(route('dashboard')); ?>"><img src="<?php echo e(asset('new/img/logonew.png')); ?>" class="header-brand-img desktop-logo-dark" alt="logo"></a>
            </div>
        ...
        <div class="main-header-right">
                    ...
                    <div class="d-flex order-lg-2 ms-auto">
                        ...
                        <div class="dropdown d-flex main-header-notification">
                            <a class="nav-link icon" href="javascript:void(0);">
                                ...
                                <span class="badge bg-info nav-link-badge"><?php echo count(auth()->user()->unreadNotifications); ?></span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    <div class="d-flex">
                                        <p class="main-notification-text mx-0 my-auto">Notifications <?php echo count(auth()->user()->unreadNotifications)?></p>
                                ...
                                <div class="main-notification-list">
                                    ...
                                    <?php 
                                        if($notify->type == 'App\notification\UserNotification' || $notify->type == 'App\notification\UserNotice'){
                                            
                                            $userNotifi = App\Models\Employee::where('user_id',$notify->data['user_id'])->first();
                                        }elseif($notify->type == 'App\notification\notificationStatus'){
                                            $userNotifi = App\Models\Employee::where('user_id',$notify->data['approvedBy'])->first();
                                        }
                                    ?>
                                    <div class="media new">
                                        <div class="main-img-user online">
                                            <?php if($userNotifi->photo != ''): ?>
                                            <img alt="avatar" src="<?php echo e(asset($userNotifi->photo)); ?>">
                                            <?php else: ?>
                                            <img alt="avatar" src="<?php echo e(asset('new/img/images.png')); ?>">
                                            <?php endif; ?>
                                        </div>
                                        <div class="media-body">
                                            <?php if($notify->type == 'App\notification\UserNotice'): ?>
                                            <a href="<?php echo e(url('notice-detail',$notify->id)); ?>">
                                            <?php else: ?>
                                            <a href="<?php echo e(url('notification',$notify->id)); ?>">
                                            <?php endif; ?>
                                                <p><strong><?php echo e($userNotifi->name); ?></strong> 
                                                <?php if($notify->type == 'App\notification\UserNotification'): ?>
                                                <?php echo e($notify->data['description']); ?>

                                                <?php elseif($notify->type == 'App\notification\notificationStatus'): ?>
                                                    <?php if($notify->data['status'] == 1): ?>
                                                        Approved Your Leave 
                                                    <?php elseif($notify->data['status'] == 2): ?>
                                                        Disapprove Your Leave
                                                    <?php endif; ?>
                                                <?php elseif($notify->type == 'App\notification\UserNotice'): ?>
                                                <?php echo e($notify->data['description']); ?>
                                ...
                                <div class="dropdown-footer">
                                    <a href="/all-notification">View All Notifications</a>
                                </div>
                            </div>
                        </div>
                        <!-- notifications -->
                        <div class="dropdown d-flex main-profile-menu">
                            <a class="d-flex" href="javascript:void(0);">
                                <span class="main-img-user">
                                    <?php if(isset(\Auth::user()->employee->photo) && (\Auth::user()->employee->photo != "")): ?>
                                    <img alt="avatar" src="<?php echo e(asset(\Auth::user()->employee->photo)); ?>">
                                    <?php else: ?>
                                    <img alt="avatar" src="<?php echo e(asset('new/img/images.png')); ?>">
                                    <?php endif; ?>
                                </span>
                            ...
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    ...
                                    <p class="main-notification-text"> <?php echo e(Auth::user()->role->role->name); ?></p>
                                </div>
            ...
            <!--    <a class="nav-link icon" href="javascript:void(0);">-->
            <!--        <svg class="settings-icon fa-spin" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">-->
