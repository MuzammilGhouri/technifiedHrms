...
<div class="row row-sm">
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card mt-5">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('attendance-upload-sheet')); ?>" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom mb-0 border dataTable no-footer" id="recentorders" role="grid" aria-describedby="recentorders_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(getFormattedDate($file->date)); ?></td>
                                <td>
                                    <!--<a href="" class="btn ripple btn-primary btn-sm">Edit</a>-->
                                    <a href="/delete-file/<?php echo e($file->id); ?>" class="btn ripple btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
