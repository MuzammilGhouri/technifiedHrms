...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card mg-b-20 mt-5" id="tabs-style3">
            ...
            <div class="card-body">
                <div class="text-wrap">
                    <form action="<?php echo e(route('updWork')); ?>" method="post" enctype="multipart/form-data">
                                        		...
                                        		<div data-repeater-list="group_job">
                                        			<div data-repeater-item>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="jobTitle[]" id="code" class="form-control" placeholder="" value="<?php echo e($val->jobTitle); ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="designation" class="form-label tx-semibold">Company Name</label>
                                                            <input type="text" name="companyName[]" id="designation" class="form-control" placeholder="" value="<?php echo e($val->companyName); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="designation" class="form-label tx-semibold">Location</label>
                                                            <input type="text" name="compLoc[]" id="designation" class="form-control" placeholder="" value="<?php echo e($val->compLoc); ?>">
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
                                                                <label for="date_of_joining" class="form-label tx-semibold">Start Date</label>
                                                                <input type="date" name="job_date_of_joining[]" id="job_date_of_joining" class="form-control" placeholder="" value="<?php echo e($val->job_date_of_joining); ?>">
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="date" name="job_date_of_confirmation[]" id="job_date_of_confirmation"  class="form-control" placeholder="" value="<?php echo e(($val->job_date_of_confirmation != "")?$val->job_date_of_confirmation:""); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex justify-content-end">
                                                            <button type="button" onclick="deleteExperience(<?php echo e($val->id); ?>, this)"  class="btn btn-danger">Delete</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
